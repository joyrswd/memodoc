...
<div class="position-absolute top-50 start-50 translate-middle col-md-3">
    ...
    <form method="POST" action="{{ route('login') }}" class="mb-4">
        ...
        <div class="mt-3 overflow-hidden">
            ...
            @enderror
            <a class="float-end mt-2 text-info-emphasis small-link" href="{{ route('user.create') }}">新規登録</a>
        </div>
        <div class="overflow-hidden">
            ...
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
            <a class="float-end mt-2 text-info-emphasis small-link" href="{{ route('password.request') }}">再設定</a>
        </div>
    ...
    @endauth
    <p class="text-center"><a href="{{ route('about') }}" class="text-secondary-emphasis small-link">当サイトについて</a></p>
</div>
@endsection